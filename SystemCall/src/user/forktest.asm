...
user/_forktest: formato do arquivo elf64-littleriscv
...
forktest(void)
{
  ...
  36:	3be50513          	addi	a0,a0,958 # 3f0 <trace+0x8>
  ...
  58:	3ec50513          	addi	a0,a0,1004 # 440 <trace+0x58>
  ...
  6e:	39650513          	addi	a0,a0,918 # 400 <trace+0x18>
  ...
  80:	39c50513          	addi	a0,a0,924 # 418 <trace+0x30>
  ...
  b0:	38450513          	addi	a0,a0,900 # 430 <trace+0x48>
