...
user/_trace1: formato do arquivo elf64-littleriscv
...
int main() {
   ...
   c:	42010413          	addi	s0,sp,1056
    printf("=== TESTE 1: Rastreamento de syscall READ ===\n");
  10:	00001517          	auipc	a0,0x1
  14:	8e050513          	addi	a0,a0,-1824 # 8f0 <malloc+0xfe>
  18:	726000ef          	jal	73e <printf>
    printf("Equivalente a: trace 32 grep hello README\n");
  1c:	00001517          	auipc	a0,0x1
  20:	90c50513          	addi	a0,a0,-1780 # 928 <malloc+0x136>
  24:	71a000ef          	jal	73e <printf>
    printf("Mascara: 32 = 1<<5 (SYS_read)\n\n");
  28:	00001517          	auipc	a0,0x1
  2c:	93050513          	addi	a0,a0,-1744 # 958 <malloc+0x166>
  30:	70e000ef          	jal	73e <printf>
    
    // Ativar trace apenas para read (32 = 1 << SYS_read)
    trace(32);
  34:	02000513          	li	a0,32
  38:	386000ef          	jal	3be <trace>
    
    // Simular o que grep faria: ler arquivo em chunks
    int fd = open("README", 0);
  3c:	4581                	li	a1,0
  3e:	00001517          	auipc	a0,0x1
  42:	93a50513          	addi	a0,a0,-1734 # 978 <malloc+0x186>
  46:	310000ef          	jal	356 <open>
    if(fd < 0) {
  4a:	04054663          	bltz	a0,96 <main+0x96>
  4e:	40913423          	sd	s1,1032(sp)
  52:	84aa                	mv	s1,a0
    }
  ...
  58:	95450513          	addi	a0,a0,-1708 # 9a8 <malloc+0x1b6>
  5c:	6e2000ef          	jal	73e <printf>
    while((bytes_read = read(fd, buf, sizeof(buf))) > 0) {
  60:	40000613          	li	a2,1024
  64:	be040593          	addi	a1,s0,-1056
  68:	8526                	mv	a0,s1
  6a:	2c4000ef          	jal	32e <read>
  6e:	fea049e3          	bgtz	a0,60 <main+0x60>
    ...
    close(fd);
  72:	8526                	mv	a0,s1
  74:	2ca000ef          	jal	33e <close>
    printf("\nTeste 1 concluido!\n");
  78:	00001517          	auipc	a0,0x1
  7c:	95850513          	addi	a0,a0,-1704 # 9d0 <malloc+0x1de>
  80:	6be000ef          	jal	73e <printf>
    printf("Observe que apenas as syscalls READ foram rastreadas.\n");
  84:	00001517          	auipc	a0,0x1
  88:	96450513          	addi	a0,a0,-1692 # 9e8 <malloc+0x1f6>
  8c:	6b2000ef          	jal	73e <printf>
    exit(0);
  90:	4501                	li	a0,0
  92:	284000ef          	jal	316 <exit>
  96:	40913423          	sd	s1,1032(sp)
        printf("Erro: nao conseguiu abrir README\n");
  9a:	00001517          	auipc	a0,0x1
  9e:	8e650513          	addi	a0,a0,-1818 # 980 <malloc+0x18e>
  a2:	69c000ef          	jal	73e <printf>
        exit(1);
  a6:	4505                	li	a0,1
  a8:	26e000ef          	jal	316 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	62650513          	addi	a0,a0,1574 # a28 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 69c:	390b8b93          	addi	s7,s7,912 # a28 <digits>
 ...
 6ea:	33a90913          	addi	s2,s2,826 # a20 <malloc+0x22e>
        for(; *s; s++)
